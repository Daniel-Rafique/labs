...
export const JITO_API_ENDPOINT = "https://mainnet.block-engine.jito.wtf/api/v1";
...
export const JITO_TRANSACTION_ENDPOINTS = [
...
export const JITO_MIN_TIP_LAMPORTS = 10000; // 10,000 lamports (0.00001 SOL)

// Recommended priority fee for Jito transactions (microlamports)
export const JITO_PRIORITY_FEE_MICROLAMPORTS = 25000; // 25,000 microlamports

// Fee distribution percentages
export const JITO_FEE_DISTRIBUTION = {
