...
function showBanner() {
  ...
  console.log(chalk.cyan('AI Assistant by Koynlabs\n'));
}
...
async function showMainMenu() {
  ...
  // Debug logging
  // console.log(chalk.yellow("Debug: Available menu items:"));
  ...
  // console.log("- Distribute SOL");
  // console.log("- Dust Collection");
  // console.log("- Create Profiles");
  // console.log("- Post PumpFun Replies");
  // console.log("\nUse arrow keys to scroll through all options.\n");
