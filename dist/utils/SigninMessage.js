...
exports.encodeMessageForSigning = exports.SigninMessage = void 0;
 ...
 */
class SigninMessage {
    constructor({ domain = "pump.fun", publicKey, nonce, statement = "Sign in with your Solana wallet.", version = "1", chainId = 101, // 101 is Solana mainnet
    resources = [], issuedAt, expiresAt, platform = "web" }) {
        this.domain = domain;
...
Platform: ${this.platform}` : ''}`;
     ...
     */
    static generateExpirationTime(minutes = 30) {
        const now = new Date();
     ...
     */
    static createPumpFunMessage(publicKey, nonce) {
     ...
     * @returns SigninMessage instance
     */
    static createFromServerNonce(publicKey, serverNonce) {
        return new SigninMessage({
            domain: "pump.fun",
            publicKey,
            nonce: serverNonce,
